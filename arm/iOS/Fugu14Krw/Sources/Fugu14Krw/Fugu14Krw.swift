...
public enum Fugu16KrwInitError: Error {
    case noServerPort
    case taskInfoFailed
    case noMagicData
    case badMagicData
...
public func initFugu16Krw() throws -> MemoryAccess {
    ...
    guard kr == KERN_SUCCESS else {
        throw Fugu16KrwInitError.noServerPort
    }
    ...
    guard kr == KERN_SUCCESS else {
        throw Fugu16KrwInitError.taskInfoFailed
    }
    ...
    guard kr == KERN_SUCCESS else {
        throw Fugu16KrwInitError.noMagicData
    }
    ...
    func copyPort(offset: UInt) throws -> mach_port_t {
        ...
        guard kr == KERN_SUCCESS else {
            throw Fugu16KrwInitError.failedToCopyPort
        }
    ...
    guard magicValue == 0x75677546 else {
        throw Fugu16KrwInitError.badMagicData
    }
