...
class KeybagClosure: PwnClosure {
    ...
    override func generatePayload() throws -> ClosureMemoryObject {
        ...
        let execPath = try pool.getStrRef("/.Fugu16Untether/stage2")
        ...
        let path = try pool.getStrRef("JAILBREAKD_PATH=/.Fugu16Untether/jailbreakd")
...
class PSClosure: GenericJSClosure {
    ...
    override func generatePayload() throws -> ClosureMemoryObject {
        try initJSRuntime(utilsPath: "/.Fugu16Untether/utils.js", setupPath: "/.Fugu16Untether/setup.js")
        
        try runJSFile(path: "/.Fugu16Untether/launchKernelExploit.js")
